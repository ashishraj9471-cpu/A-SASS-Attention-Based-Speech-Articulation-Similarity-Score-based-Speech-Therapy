...
liveportrait_pipeline = load_liveportrait()
...
def generate_reenactment(
    ...
    source_image = extract_first_frame(
    ...
    args = ArgumentConfig(
        ...
        driving=therapist_video,

        output_dir=output_dir

    )

    liveportrait_pipeline.execute(
        args
    )
...
if st.button(
    ...
    with st.spinner(
        ...
        reenacted_video = generate_reenactment(
        ...
        st.success(
            "Reenactment Generated"
        )
        if "reenacted_video" in st.session_state:

    st.subheader(
        "Generated Reenactment"
    )
...
if therapist_file:
    ...
    reenacted_features = extract_features(
